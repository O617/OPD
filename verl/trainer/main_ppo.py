...
if __name__ == "__main__":
    ...
    _teacher_env_keys = (
        ...
        # OPD: chunk-cache dump for P0-1 paired-sanity
        "OPD_CHUNK_CACHE_DIR",
        "OPD_CHUNK_CACHE_MAX_STEPS",
        # vLLM / flashinfer runtime toggles — must be forwarded to Ray workers
        # or their spawned vLLM processes will crash with cubin version / fork
        # errors on this node.
        "VLLM_WORKER_MULTIPROC_METHOD",
        "VLLM_ATTENTION_BACKEND",
        "FLASHINFER_DISABLE_VERSION_CHECK",
        "FLASHINFER_CUBIN_DIR",
        # Corporate HTTP proxy — wandb.init on the driver needs this to reach
        # api.wandb.ai; forward so any Ray-spawned wandb hooks also see it.
        "http_proxy",
        "https_proxy",
        "HTTP_PROXY",
        "HTTPS_PROXY",
