...
# ---- Fix memlock limit for RDMA (ibv_reg_mr) ----
# Container default is 64 KB which causes "ibv_reg_mr_iova2 Invalid argument".
# RDMA needs to pin GPU/host memory; unlimited is required.
ulimit -l unlimited

# ---- NCCL InfiniBand / RoCE configuration ----
# Explicitly set here so non-interactive shells (Slurm, Ray, cron) always get them,
# regardless of whether ~/.bashrc's interactive guard blocks the definitions.
...
exp_name='OPD_Qwen_Qwen'   # DIFF: was OPD
